...
Also made changes on primary producer mortality, and added:
flag_replicated_old_PPmort 0 #Flag to replicate old model code assumptions around primary production mortality before code version 6685
