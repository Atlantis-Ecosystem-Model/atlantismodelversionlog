...
**SVN commit message** 
------------------------------------------------------------------------
r6707 | ful083 | 2024-03-30 07:20:31 -0700 (Sat, 30 Mar 2024) | 3 lines
Changed paths:
...
void ContaminantFisheryXML(MSEBoxModel *bm, FILE *fp, char *f <
    int cIndex;						      <
    char varStr[STRLEN*2];				      <
    char longStr[2*STRLEN];				      <
							      <
    xmlNodePtr groupingNode;				      <
    groupingNode = Util_XML_Create_Node(ATLANTIS_ATTRIBUTE_SU <
							      <
    /* not sure this is going to give the correct array lengt <
    ...
    for(cIndex = 0; cIndex < bm->num_contaminants; cIndex++){ <
        ...
        sprintf(longStr, "Concentration of ontaminant %s wher <
